...
import com.wss.eat_space_iz.data.networkModels.blogsTab.viewFavourite.Favourite
...
class FollowerAndFollowingFragment : BaseFrag<FragmentFollowerAndFollowingBinding,
    ...
    private lateinit var mFollowerDataList: List<Follower>

    private lateinit var mFollowingAdapter: FollowingAdapter
    private lateinit var mFollowingDataList: List<Following>
    ...
    private fun setupMyFollowersRecyclerView(data: List<Follower>) {
    ...
    private fun setupMyFollowingRecyclerView(data: List<Following>) {
