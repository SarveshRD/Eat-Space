...
import com.wss.eat_space_iz.data.networkModels.cartTab.viewAdminOffers.ViewAdminOffersData
...
class DiscountCodeFragment : BaseFrag<FragmentDiscountCodeBinding, DiscountCodeViewModel>(Layouts.fragment_discount_code)
{
    ...
    private lateinit var mDiscountCodeDataList : List<ViewAdminOffersData>
  //test
    ...
    private fun setupActiveCampaignRecyclerView(data: List<ViewAdminOffersData>) {
