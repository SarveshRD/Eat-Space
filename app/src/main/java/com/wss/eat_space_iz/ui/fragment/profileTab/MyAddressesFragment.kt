...
import com.wss.eat_space_iz.data.networkModels.profileTab.viewUserAddress.ViewUserAddressData
...
class MyAddressesFragment :
    ...
    private var mViewUserAddressData: List<ViewUserAddressData>? = null
    ...
    private fun setUpUserAddressDetailsRecycler(viewUserAddressData: List<ViewUserAddressData>) {
